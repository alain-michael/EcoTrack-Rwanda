                ...
                <table className="w-full bg-white">
                    <thead>
                        <tr className="shadow-lg mb-2">
                            ...
                            <th onClick={() => handleSort("first_name")} className="text-left text-gray-500 font-medium  px-10 py-2 text-nowrap">First Name</th>
                            <th onClick={() => handleSort("last_name")} className="text-left text-gray-500 font-medium  px-10 py-2 text-nowrap">Last Name</th>
                            <th onClick={() => handleSort("email")} className="text-left text-gray-500 font-medium  px-10 py-2 text-nowrap">Email</th>
                            <th onClick={() => handleSort("user_role")} className="text-left text-gray-500 font-medium  px-10 py-2 text-nowrap">Role</th>
