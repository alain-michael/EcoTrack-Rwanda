...
SECRET_KEY = 'django-insecure-ew^^pjz8yq1feg$!!7iib+p9-^k1%xj_dy^6py^slyp_ibodln'
...
CORS_ALLOWED_ORIGINS = [
    ...
    "https://eco-track-rw.netlify.app",
]
...
EMAIL_PORT = 587
EMAIL_USE_TLS = True
EMAIL_HOST_USER = 'ecotrackrw@gmail.com'
EMAIL_HOST_PASSWORD = 'gqpy ywis uicq xbjz'
EMAIL_USE_SSL = False
